...
def load_parameters():
    FIXED_PARAMETERS = {
        ...
        "training_mnli": "{}/multinli_0.9/multinli_0.9_train.spacy.jsonl".format(args.datapath),
        "dev_matched": "{}/multinli_0.9/multinli_0.9_dev_matched.spacy.jsonl".format(args.datapath),
        "dev_mismatched": "{}/multinli_0.9/multinli_0.9_dev_mismatched.spacy.jsonl".format(args.datapath),
        "test_matched": "{}/multinli_0.9/multinli_0.9_test_matched_unlabeled.spacy.jsonl".format(args.datapath),
        "test_mismatched": "{}/multinli_0.9/multinli_0.9_test_mismatched_unlabeled.spacy.jsonl".format(args.datapath),
        "training_snli": "{}/snli_1.0/snli_1.0_train.spacy.jsonl".format(args.datapath),
        "dev_snli": "{}/snli_1.0/snli_1.0_dev.spacy.jsonl".format(args.datapath),
        "test_snli": "{}/snli_1.0/snli_1.0_test.spacy.jsonl".format(args.datapath),
